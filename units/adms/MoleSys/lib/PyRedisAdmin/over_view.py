        ...
        if status:
            ...
            <div class="server">
              ...
              <table>
                  ...
                  <tr><td><div>Last save:</div></td><td><div>%(last_save_time)s <a href="/save?s=%(s_index)s"><img src="/pyred_media/images/save.png" width="16" height="16" title="Save Now" alt="[S]" class="imgbut"></a></div></td></tr>
              </table></div>'''%({
                            'name': server['name'],
