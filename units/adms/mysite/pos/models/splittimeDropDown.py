...
class ZSplitChoiceWidget(forms.Select):
    flat = False
    def __init__(self, attrs={}, choices=()):
        super(ZSplitChoiceWidget, self).__init__(attrs=attrs, choices=choices)
...
#                    if not l:ii.parent_id=None 
            ...
            if self.flat == False:#平铺
               return u'''<input %(required)s class="wZBaseCharField input_showDeptTree" type="text" readonly="readonly" value="%(disp)s"/><input type=hidden name="%(name)s" value="%(value)s"/>
...
class ZSplitTimeChoiceFlatWidget(ZSplitChoiceWidget):
    flat=True

class ZSplitTimeMultiChoiceWidget(forms.SelectMultiple):
    flat=False
    def __init__(self, attrs={}, choices=()):
        super(ZSplitTimeMultiChoiceWidget, self).__init__(attrs=attrs, choices=choices)
...
class ZSplitTimeMultiChoiceDropDownWidget(ZSplitTimeMultiChoiceWidget):
    flat=False
