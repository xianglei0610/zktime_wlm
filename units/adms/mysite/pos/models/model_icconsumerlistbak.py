...
class ICConsumerListBak(models.Model,OperationBase):  
...
##        raise Exception(_(u'该人员的消费记录不允许删除'))
    ...
    class Admin:
        ...
        list_display= ["user_pin","user_name","dept.name","card","sys_card_no","type_name","money","balance","pos_model","dining.name","meal.name","dev_sn","dev_serial_num","card_serial_num","pos_time","convey_time","log_flag","create_operator"]
