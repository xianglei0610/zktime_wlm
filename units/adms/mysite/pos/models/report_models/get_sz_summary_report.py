...
class GetSzSummaryReport(GridModel):
    verbose_name=_(u'现金收支表')
    app_menu ="pos"
    menu_index=3
    visible = False
    ...
    def __init__(self,request):
        ...
        super(GetSzSummaryReport, self) .__init__()
        #设置 colum_trans 属性
        ...
        self.grid.fields["summary_date"]["width"]=180
        self.grid.fields["operate"]["width"]=120
