...
class GetEmpSummaryReport(GridModel):
    verbose_name=_(u'个人消费汇总表')
    app_menu ="pos"
    menu_index=3
    visible = False
    ...
    def __init__(self,request):
        ...
        super(GetEmpSummaryReport, self) .__init__()
        #设置 colum_trans 属性
        ...
        self.grid.fields["summary_count"]["width"]=180
        self.grid.fields["summary_dev_money"]["width"]=180
