...
#        FieldCaption=[_(u'餐厅名称'),_(u'早餐合计（元）'),_(u'中餐合计（元）'),_(u'晚餐合计（元）'),_(u'夜宵合计（元）'),_(u'纠错金额（元）'),_(u'合计金额（元)'),_(u'消费日期')]
            FieldNames=['dining_name','pos_count','meal_money','back_count','back_money','summary_total_time','add_single_money','summary_count','summary_dev_money','summary_money','pos_date']
            FieldCaption=[_(u'餐厅名称'),_(u'消费次数'),_(u'消费合计'),_(u'纠错次数'),_(u'纠错合计'),_(u'计次结算'),_(u'补单合计'),_(u'实消费次数结算'),_(u'设备金额结算'),_(u'系统金额结算（含补单）'),_(u'消费日期')]
        else:
            ...
            FieldCaption=[_(u'餐厅名称'),_(u'消费次数'),_(u'消费合计'),_(u'纠错次数'),_(u'纠错合计'),_(u'计次结算'),_(u'计次结算'),_(u'补单合计'),_(u'实消费次数结算'),_(u'设备金额结算'),_(u'系统金额结算（含补单）'),_(u'消费日期')]
        for t in FieldNames:
            r[t]=''
        ...
        if get_option("POS_IC"):
            ...
            FieldCaption=[_(u'人员编号'),_(u'人员姓名'),_(u'部门名称'),_(u'消费次数'),_(u'补单合计'),_(u'消费合计'),_(u'纠错次数'),_(u'纠错合计'),_(u'计次结算'),_(u'计次结算'),_(u'实消费次数结算'),_(u'设备金额结算'),_(u'系统金额结算（含补单）'),_(u'消费日期')]
        for t in FieldNames:
            r[t]=''
       ...
       if get_option("POS_IC"):
           ...
           FieldCaption=[_(u'部门名称'),_(u'消费次数'),_(u'消费合计'),_(u'纠错次数'),_(u'纠错合计'),_(u'计次结算'),_(u'实消费次数结算'),_(u'结算金额'),_(u'消费日期')]
       else:
           ...
           FieldCaption=[_(u'部门名称'),_(u'消费次数'),_(u'消费合计'),_(u'纠错次数'),_(u'纠错合计'),_(u'计次结算'),_(u'计次结算'),_(u'实消费次数结算'),_(u'结算金额'),_(u'消费日期')]
       for t in FieldNames:
           r[t]=''
       
    elif typeid=="140": #设备汇总
        if get_option("POS_IC"):
           FieldNames=['device_name','device_sn','pos_count','meal_money','back_count','back_money','summary_total_time','add_single_money','summary_count','summary_dev_money','summary_money','pos_date']
           FieldCaption=[_(u'设备名称'),_(u'设备序列号'),_(u'消费次数'),_(u'消费合计'),_(u'纠错次数'),_(u'纠错合计'),_(u'计次结算'),_(u'补单合计'),_(u'实消费次数结算'),_(u'设备金额结算'),_(u'系统金额结算（含补单）'),_(u'消费日期')]
        else:
           ...
           FieldCaption=[_(u'设备名称'),_(u'设备序列号'),_(u'消费次数'),_(u'消费合计'),_(u'纠错次数'),_(u'纠错合计'),_(u'计次结算'),_(u'计次结算'),_(u'补单合计'),_(u'实消费次数结算'),_(u'设备金额结算'),_(u'系统金额结算（含补单）'),_(u'消费日期')]
        for t in FieldNames:
           r[t]=''
        ...
        for t in FieldNames:
            ...
            if get_option("POS_IC"):
                ...
                FieldCaption=[_(u'人员编号'),_(u'姓名'),_(u'部门名称'),_(u'卡号'),_(u'卡账号'),_(u'卡流水号'),_(u'补贴类型'),_(u'补贴金额'),_(u'卡余额'),_(u'补贴时间'),_(u'上传时间'),_(u'操作员'),_(u'设备流水号'),_(u'设备序列号'),_(u'记录类型')]
            else:
                FieldNames=['user_pin','user_name','dept_name','card','card_serial','money','card_blance','check_time','create_operator']
